...
use crate::grpc::conn_pool::{ConnectionManager as InternalConnectionManager, Error as InternalConnectionError };
...
impl ConnectionManager {
    pub async fn new(pool_size: usize, emulator_host: Option<String>) -> Result<Self, Error> {
        Ok(ConnectionManager {
            inner: InternalConnectionManager::new(pool_size, SPANNER, AUDIENCE, emulator_host).await?,
            token_source: Some(Arc::from(create_token_source(Config {
